...
import java.net.URL;
    ...
    public class RegisterMemberTest3 {
        ...
        public void registerMember() {
            ...
            driver.findElement(By.id("member_emailaddress")).sendKeys("RP7436@email.com");
            driver.findElement(By.id("member_confirmemailaddress")).sendKeys("RP7436@email.com");
            driver.findElement(By.cssSelector(".row:nth-child(2)")).click();
            driver.findElement(By.cssSelector(".signUp-cont--center")).click();
            driver.findElement(By.id("signupunlicenced_password")).sendKeys("754754");
            driver.findElement(By.id("signupunlicenced_confirmpassword")).sendKeys("757457");
            js.executeScript("window.scrollTo(0,400)");
            {
                WebElement element = driver.findElement(By.cssSelector(".md-checkbox > .md-checkbox:nth-child(1) > label"));
                Actions builder = new Actions(driver);
                builder.moveToElement(element).clickAndHold().perform();
            }
            {
                WebElement element = driver.findElement(By.cssSelector(".row:nth-child(12) > .col-xs-12"));
                Actions builder = new Actions(driver);
